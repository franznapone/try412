...
<head>
    ...
    <link rel="stylesheet" href="PastScholarsAdmin.css">
    <title><?php echo $fetch_info['adminName'] ?> | Past Scholar Records</title>
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
                ...
                <li>
                    <a href="#"><i class="fas fa-file"></i>Past Scholar Records</a>
                </li>   
            </ul>
        </div>
    </div>

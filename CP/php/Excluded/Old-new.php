...
<body>
    ...
    <div class="container">
        <section class="right-section">
            ...
            <h4> Please click your destination.</h4>
        <div class="login">
            <div calss=application>
                <a href="TDPoldscholar.php">
                    <button id="application">Old Scholar</button>
                </a>
                <a href="TDPnewscholar.php">
                    <div class="Admin">
                        <button id="admin">New Scholar</button>
                    </div>
                </a>
            </div>
        </div>

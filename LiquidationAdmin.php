...
<head>
    ...
    <link rel="stylesheet" href="LiquidationAdmin.css">
    <title><?php echo $fetch_info['adminName'] ?> | Liquidation Admin</title>
</head>
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="TESadmin.php"><i class="fas fa-file"></i>Tertiary Education Subsidy</a>
                </li>
                <li>
                    <a href="#"><i class="fas fa-file"></i>Liquidation</a>
                </li>
                <li>
...
<!--
        <div class="logout">
            <a href="index.php">
                <button class="homepagebtn">Homepage</button>
            </a>
            <a href="logout.php">
